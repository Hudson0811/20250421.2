...
function createMenu() {
  ...
  let button4 = createButton('作品3').parent(subMenu);
  button4.style('width', '120px'); // 放大按鈕寬度
  button4.style('margin-bottom', '5px'); // 增加按鈕間距
  button4.mousePressed(() => alert('這是作品3的內容！'));

  let button5 = createButton('作品4').parent(subMenu);
  button5.style('width', '120px'); // 放大按鈕寬度
  button5.mousePressed(() => alert('這是作品4的內容！'));
